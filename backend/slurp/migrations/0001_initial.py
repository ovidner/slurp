    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('quantity', models.PositiveIntegerField(choices=[(0, '0 cl'), (2, '2 cl'), (4, '4 cl'), (6, '6 cl'), (8, '8 cl'), (10, '10 cl'), (12, '12 cl'), (14, '14 cl'), (16, '16 cl'), (18, '18 cl'), (20, '20 cl'), (22, '22 cl'), (24, '24 cl')], default=0, verbose_name='quantity')),
            ],
            options={
        ...
        migrations.AddField(
            ...
            name='person',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='slurp.Person', verbose_name='person'),
        ),
    ]
